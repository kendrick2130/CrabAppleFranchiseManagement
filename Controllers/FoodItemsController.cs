...
namespace FranchiseManagement.Controllers
{
    public class FoodItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FoodItemID,Name,Price,FoodItemDescription")] FoodItem foodItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FoodItemID,Name,Price,FoodItemDescription")] FoodItem foodItem)
        {
